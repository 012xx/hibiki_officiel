...
<div>
    <form action="confirm.php" method="post">
            ...
            <input type="hidden" name="genjitu" value="<?php echo $genjitu; ?>">
            <input type="hidden" name="sonota" value="<?php echo $sonota; ?>">
            ...
            <div>
                ...
                <div>
                    <label>出会い：</label><?php echo $Twitter; ?>
                </div>
                <div>
                    <label>出会い：</label><?php echo $YouTube; ?>
                </div>
                <div>
                    <label>出会い：</label><?php echo $genjitu; ?>
                </div>
                <div>
                    <label>出会い：</label><?php echo $sonota; ?>
                </div>
                <div>
